...
public class LavaFloor : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            other.gameObject.GetComponentInParent<HealthManager>().TakeDamage(damage, false, null, "Crate Crab", transform);
            timer = tickrate;
        }
    }
    private void OnCollisionStay(Collision collision)
    {
        ...
        {
            collision.gameObject.GetComponentInParent<HealthManager>().TakeDamage(damage, false, null, "Crate Crab", transform);
            timer = tickrate;
        }
    }
}
